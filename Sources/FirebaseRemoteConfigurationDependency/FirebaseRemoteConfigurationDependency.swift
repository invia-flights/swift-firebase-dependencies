...
public struct FirebaseRemoteConfigurationClient: Sendable {
	public init(configure: @escaping @Sendable (FetchSettings) -> Void, setDefaultsFromPlist: @escaping @Sendable (String?) -> Void, lastFetchTime: @escaping @Sendable () -> Date?, lastFetchStatus: @escaping @Sendable () -> FetchStatus, ensureInitialized: @escaping @Sendable () async throws -> Void, fetch: @escaping @Sendable () async throws -> FetchStatus, fetchWithExpirationDuration: @escaping @Sendable (TimeInterval) async throws -> FetchStatus, fetchAndActivate: @escaping @Sendable () async throws -> FetchAndActivateStatus, activate: @escaping @Sendable () async throws -> Bool, stringForKey: @escaping @Sendable (String) -> String?, numberForKey: @escaping @Sendable (String) -> NSNumber?, dataForKey: @escaping @Sendable (String) -> Data?, boolForKey: @escaping @Sendable (String) -> Bool?, jsonForKey: @escaping @Sendable (String) -> JSONSerialization?) {
