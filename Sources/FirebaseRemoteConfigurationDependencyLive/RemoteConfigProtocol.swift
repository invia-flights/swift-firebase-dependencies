...
public protocol RemoteConfigProtocol: AnyObject {
	...
	func configValue(forKey key: String?, source: FirebaseRemoteConfig.RemoteConfigSource)
		-> RemoteConfigValue
